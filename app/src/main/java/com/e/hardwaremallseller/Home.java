...
import com.e.hardwaremallseller.adapter.CategoryAdapter;
import com.e.hardwaremallseller.adapter.ProductAdapter;
import com.e.hardwaremallseller.apis.CategoryService;
import com.e.hardwaremallseller.apis.ProductService;
import com.e.hardwaremallseller.apis.ShopkeeperService;
import com.e.hardwaremallseller.beans.Category;
import com.e.hardwaremallseller.beans.Product;
import com.e.hardwaremallseller.beans.Shopkeeper;
import com.e.hardwaremallseller.databinding.ActivityHomeBinding;
import com.e.hardwaremallseller.databinding.CategoryItemListBinding;
import com.e.hardwaremallseller.databinding.NavigationHeaderBinding;
...
//                Toast.makeText(Home.this, "ss", Toast.LENGTH_SHORT).show();
                if(response.code()==200) {
                    ...
                    if (LatestToken.equals(fetchedToken)) {
                        Toast.makeText(Home.this, "same token !!"+fetchedToken, Toast.LENGTH_SHORT).show();
                    }
                }
            }
